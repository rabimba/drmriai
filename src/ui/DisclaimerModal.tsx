    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-zinc-700 rounded-lg max-w-lg w-full p-6">
        ...
        <p className="text-zinc-300 mb-4">
          Dr.MRI.AI is an educational and research tool developed by Rabimba.
        </p>
        <ul className="text-zinc-400 text-sm space-y-2 mb-6">
          ...
          <li className="flex gap-2">
            <span className="text-zinc-500 shrink-0">&bull;</span>
            When using AI analysis, image data is sent only to the provider you select in settings according to that provider&apos;s data handling policies
          </li>
        </ul>
