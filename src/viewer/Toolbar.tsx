...
function PortalDropdown({
  ...
  return createPortal(
    <>
      ...
      <div
        className="fixed z-[9999] min-w-[180px] rounded-2xl border border-white/10 bg-[rgba(12,16,24,0.96)] py-1 shadow-xl pointer-events-auto"
...
export default function Toolbar({
  ...
  return (
    <div className="relative z-20 flex items-center gap-1 px-3 py-2 overflow-x-auto whitespace-nowrap">
